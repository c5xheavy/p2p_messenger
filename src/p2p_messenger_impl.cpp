...
P2PMessengerImpl::P2PMessengerImpl(const std::string& my_login, uint16_t dht_port,
    ...
    , message_sender_{socket_, my_ip_, my_port_, my_login_, identity_, relay_node_ip_, relay_node_port_, [this, send_message_handler = std::move(send_message_handler)](Message&& message) {
